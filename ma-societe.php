...
<html lang="fr">
    ...
    <body>
        ...
        <section class="societeMenu">
            <div class="logo">
                <img src="img/isaac-logo.svg">
            </div>
            <ul class="menuBO">  
                <li class="picto1">Dashboard</li>
                <li class="picto2">Ma société</li>
            ...
            <div class="question">
                    ...
                    <div class="picto8"><img src="./img/dashboard/noun_781972.svg"></div>
                </div>
        </section>
        ...
        <section class="societeBoard">
            ...
            <ul class="forms-societe">
                        ...
                        <li>
                            ...
                            <select name="forme-juridique" id="forme-juridique">
                                ...
                                <option value="ac">Agents commerciaux</option>
                                <option value="gie">GIE</option>
                            </select>


                            
                            <!--<input type="text" name="forme-juridique" id="forme-juridique" placeholder="Forme juridique" autofocus required/>-->
                        </li>
                        <li>
                        ...
                        <li class="bo-checkbox">
                            <label>
                                <input type="checkbox" id="bo-so-cbox1" value="bo-so-cbox1">Sonore
                            </label>
                        </li>
                        <li class="bo-checkbox">
                            <label>
                                <input type="checkbox" id="bo-so-cbox2" value="bo-so-cbox2">Hologramme
                            </label>
                        </li>
                        <li class="bo-checkbox">
                            <label>
                                <input type="checkbox" id="bo-so-cbox3" value="bo-so-cbox3">Tridimensionnelle
                            </label>
                        </li>
                        <li class="bo-checkbox">
                            <label>
                                <input type="checkbox" id="bo-so-cbox4" value="bo-so-cbox4">Couleurs
                            </label>
                        </li>
                        <li class="bo-checkbox">
                            <label>
                                <input type="checkbox" id="bo-so-cbox5" value="bo-so-cbox5">Autres caractéristiques
                            </label>
                        </li>
                </ul>
